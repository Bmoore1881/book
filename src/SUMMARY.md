  ...
  - [CLI Reference](./reference/cli/README.md) <!-- CLI_REFERENCE START -->
    - [`forge`](./reference/cli/forge.md)
      ...
      - [`forge soldeer`](./reference/cli/forge/soldeer.md)
        ...
        - [`forge soldeer clean`](./reference/cli/forge/soldeer/clean.md)
    ...
    - [`cast`](./reference/cli/cast.md)
      ...
      - [`cast abi-encode-event`](./reference/cli/cast/abi-encode-event.md)
      ...
      - [`cast b2e-payload`](./reference/cli/cast/b2e-payload.md)
      ...
      - [`cast erc20-token`](./reference/cli/cast/erc20-token.md)
        - [`cast erc20-token balance`](./reference/cli/cast/erc20-token/balance.md)
        - [`cast erc20-token transfer`](./reference/cli/cast/erc20-token/transfer.md)
        - [`cast erc20-token approve`](./reference/cli/cast/erc20-token/approve.md)
        - [`cast erc20-token allowance`](./reference/cli/cast/erc20-token/allowance.md)
        - [`cast erc20-token name`](./reference/cli/cast/erc20-token/name.md)
        - [`cast erc20-token symbol`](./reference/cli/cast/erc20-token/symbol.md)
        - [`cast erc20-token decimals`](./reference/cli/cast/erc20-token/decimals.md)
        - [`cast erc20-token total-supply`](./reference/cli/cast/erc20-token/total-supply.md)
        - [`cast erc20-token mint`](./reference/cli/cast/erc20-token/mint.md)
        - [`cast erc20-token burn`](./reference/cli/cast/erc20-token/burn.md)
      ...
      - [`cast pad`](./reference/cli/cast/pad.md)
      ...
      - [`cast recover-authority`](./reference/cli/cast/recover-authority.md)
      ...
      - [`cast trace`](./reference/cli/cast/trace.md)
      ...
      - [`cast wallet`](./reference/cli/cast/wallet.md)
        ...
        - [`cast wallet derive`](./reference/cli/cast/wallet/derive.md)
